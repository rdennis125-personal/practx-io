...
| `AZURE_STATIC_WEB_APPS_API_TOKEN_DELIGHTFUL_GROUND_06C5F621E` | `.github/workflows/azure-static-web-apps-delightful-ground-06c5f621e.yml`【F:.github/workflows/azure-static-web-apps-delightful-ground-06c5f621e.yml†L1-L46】 | Deployment token for the Practx Static Web App (Delightful Ground). | GitHub repository secret generated from the Static Web App resource in Azure. |

The Static Web App workflow scopes its build paths to the ELM experience via the `PRACTX_ELM_WEB_APP_LOCATION` and `PRACTX_ELM_WEB_BUILD_OUTPUT` environment variables. Adjust them only if the ELM frontend moves within the monorepo.【F:.github/workflows/azure-static-web-apps-delightful-ground-06c5f621e.yml†L1-L46】
